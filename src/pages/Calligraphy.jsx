...
export default function Calligraphy() {
  ...
  const services = [
    { key:'calli',    title: t('c_calli_title'),    desc: t('c_calli_desc') },
    { key:'signs',    title: t('c_signs_title'),    desc: t('c_signs_desc') },
    { key:'interior', title: t('c_interior_title'), desc: t('c_interior_desc') },
    { key:'plaques',  title: t('c_plaques_title'),  desc: t('c_plaques_desc') },
    { key:'deco',     title: t('c_deco_title'),     desc: t('c_deco_desc') },
    { key:'monument', title: t('c_monument_title'), desc: t('c_monument_desc') },
  ]
        ...
        <div className={styles.container}>
          <FadeIn direction="up">
            <div className={styles.sectionHead}>
              <SectionTag variant="red">{t('cal_section_tag')}</SectionTag>
              <h2>{t('cal_section_h2')}</h2>
